...
/**
 * Repository "Section" and "GeoClass"
 */
@Slf4j
@Component
public class SectionDAO {
    ...
    /**
     * Method finds GeoClass by section name
     * and geoclass name and then edits code only
     *
     * @param section
     * @return
     */
    ...
    /**
     * Method deletes section and all its geological classes
     * from database by section name
     *
     * @param section
     * @return
     */
